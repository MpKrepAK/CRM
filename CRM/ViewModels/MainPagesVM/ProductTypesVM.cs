...
public class ProductTypesVM : ViewModelBase
{
    private ProductTypeRepository rep;
    
    private ObservableCollection<ProductType> _data;

    public ObservableCollection<ProductType> Data
    {
        get { return _data;}
        set { SetProperty(ref _data, value); }
    }
    
    private ProductType _chosen;

    public ProductType Chosen
    {
        get { return _chosen;}
        set { SetProperty(ref _chosen, value); }
    }
    
    private ProductType _adding;

    public ProductType Adding
    {
        get { return _adding;}
    ...
    {
        Adding = new ProductType();
        rep = new ProductTypeRepository();
        Fill();
    ...
    public async Task Fill()
    {
        try
        {
            Data = new ObservableCollection<ProductType>(await rep.GetAll());
        }
        catch (Exception e)
        {
    ...
    public void SelectionChanged(object sender, RoutedEventArgs args)
    {
        try
        {
            Chosen = (((DataGrid)sender).SelectedItem as ProductType);
        }
        catch (Exception e)
        {
